			...
			<div className='flex flex-col items-start justify-between py-12 px-4 md:p-20 mf:flex-row'>
				<div className='flex flex-1 flex-col justify-start mf:mr-10'>
					...
					<p className='mt-5 w-11/12 text-left text-base font-light text-white md:w-9/12'>
						Buy and sell crypto easily here on Krypt.
					</p>
					...
					{!currentAccount && (
						<button
							...
							className='my-5 flex cursor-pointer flex-row items-center justify-center rounded-full
       bg-[#2952e3] p-3 hover:bg-[#254cbd]'>
